...
+ (_**Optional**_) _**Bonus Levels requires**_ you to [_install_ **Node.js**](https://nodejs.org/download/)
...
- How to Write Clean, Testable Code -  https://youtu.be/XcT4yYu_TTs
...
Writing a _**failing test**_, before writing the code may seem *counter-intuitive*, *time consuming* or even "*tedious*" at _**first**_.

But we _urge_ you to think of it this way:

> The ***test*** is the ***question*** you are asking. Your code is the ***answer*** to the question. 
> 
> By having a _clear_ question, you can always check that your code is working, 
> because it _**consistently**_ gives you the same answer(s) ... _no surprises_,
...
![[Pasted image 20260609013301.webp]]
...
![[Pasted image 20260609013325.webp]]
...
Later in this workshop we use [blanket.js](https://blanketjs.org/) which is not compatible with the latest version of QUnit. It is for this reason that we are calling `test()` to run the tests in this workshop.
...
![[Pasted image 20260609013410.webp|637]]
...
Don't panic if you are _unfamiliar_ with the JavaScript `Array.Map` & `Array.Reduce` methods;
...
!![[Pasted image 20260609013949.webp]]
...
> The (_sad?_) _fact_ is: Blanket.js Code Coverage analysis will not detect _all_ bugs or rogue code.
...
[https://github.com/dwyl/**learn-istanbul**](https://github.com/dwyl/learn-istanbul) that goes into _detail_.
...
![[Pasted image 20260609014240.webp]]

Execute `open ./coverage/lcov-report/index.html` to view the detailed coverage report.
...
Then, refresh the Code Coverage report in your browser.
...
**4**)  Ensure that you have a **package.json** file with **test** script (_if in doubt, just copy-paste the **package.json** from this project!_)
