...
- the combination of the three phases defines a so called **module**. as part of every module, you also define what is called a **provider**.
...
- since Terraform is organized by modules, it is simple to replicate a module and spin up an entire "new world". this allows you to provide infrastructure for different environments (e.g.: development, homolog, production) which is totally aligned with DevOps way of thinking